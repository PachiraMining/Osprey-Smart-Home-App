...
class WeatherDetailPage extends StatelessWidget {
  ...
  static (IconData, String) _condition(WeatherRecommendation? w) {
    if (w == null) return (Icons.cloud_outlined, '--');
    if (!w.isDay) return (Icons.nightlight_outlined, 'Clear night');
    if (w.cloudCoverPercent < 20) return (Icons.wb_sunny_outlined, 'Sunny');
        ...
        builder: (context, state) {
          ...
          return ListView(
            ...
            children: [
              ...
              Text(
                w != null
                    ? 'Outdoor temperature: ${w.temperatureCelsius.round()}°C'
                    : 'Outdoor temperature: --',
                textAlign: TextAlign.center,
